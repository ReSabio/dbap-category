...
<div class="headBtnArea">
				...
				<div class="headBtn-items">
				  <?php 
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        <div><a title="<?php echo $row["name"]; ?>" href="list_product.php?cat=<?php echo $row["id"]; ?>">
                        <?php echo $row["name"]; ?>
                        </a></div>
                    <?php 
                        }
                    } else { ?>
                        echo '<div><a title="產品類別" href="list_product.php">產品類別</a></div>';
                    <?php 
                    }
                    $conn->close();
                ?>
	...
	<!-- 子選單結束 -->
		...
		?>
			<li><a title="登出" class="btn1" href="logout.php">登出(<?php echo $_SESSION['valid_user']; ?>)</a></li>
		<?php
		} else {
		?>
